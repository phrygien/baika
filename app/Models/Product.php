...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'requires_shipping', 'is_digital', 'digital_file',
        'status', 'rejection_reason', 'is_featured', 'is_active',
        'track_inventory', 'low_stock_threshold',
        'origin_country', 'hs_code', 'barcode',
        'meta_title', 'meta_description', 'meta_keywords',
        'average_rating', 'total_reviews', 'total_sold', 'total_views',
    ...
    {
        return $query->whereHas('inventory', fn($q) => $q->where('quantity_in_stock', '>', 0));
    }
    ...
    public function discountPercentage(): int
    {
        ...
        return (int) round((1 - $this->base_price / $this->compare_at_price) * 100);
    }
