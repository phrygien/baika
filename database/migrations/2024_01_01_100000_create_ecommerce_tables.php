...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table("users", function (Blueprint $table) {
            ...
            $table
                ->enum("status", ["active", "suspended", "banned", "pending"])
                ->default("pending");
        ...
        Schema::create("shipping_rates", function (Blueprint $table) {
            ...
            $table->decimal("price_per_kg", 10, 2)->default(0.0);
            $table->decimal("price_per_km", 10, 2)->default(0.0);
        ...
        Schema::create("transporter_bank_accounts", function (
            Blueprint $table,
        ) {
            $table->id();
            $table
        ...
        Schema::create("flash_sales", function (Blueprint $table) {
            ...
            $table
                ...
                ->default("flash");
            $table
                ->enum("scope", ["platform", "supplier", "collaborative"])
                ->default("platform");
            $table
                ->foreignId("organizer_supplier_id")
                ->nullable()
            ...
            $table->decimal("total_revenue", 14, 2)->default(0.0);
        ...
        Schema::create("flash_sale_products", function (Blueprint $table) {
            ...
            $table
                ...
                ->cascadeOnDelete();
            $table
                ->foreignId("flash_sale_slot_id")
                ->nullable()
                ->constrained("flash_sale_slots")
                ->nullOnDelete();
            ...
            $table->unique(
                ...
                "flash_product_unique",
            );
            $table->index(["flash_sale_id", "status"]);
            $table->index(["product_id", "status"]);
        });

        Schema::create("flash_sale_purchase_limits", function (
            Blueprint $table,
        ) {
            $table->id();
            $table
                ->foreignId("flash_sale_product_id")
                ->constrained()
                ->cascadeOnDelete();
            $table->foreignId("user_id")->constrained()->cascadeOnDelete();
        ...
        Schema::create("flash_sale_notifications", function (Blueprint $table) {
            ...
            $table
                ->foreignId("flash_sale_product_id")
                ->nullable()
                ->constrained("flash_sale_products")
                ->nullOnDelete();
            $table
                ->foreignId("category_id")
                ->nullable()
            ...
            $table->timestamps();
            $table->unique(
                ["user_id", "flash_sale_id", "notify_type"],
                "flash_notif_unique",
            );
            $table->index(["flash_sale_id", "status"]);
        });

        Schema::create("flash_sale_cart_reservations", function (
            Blueprint $table,
        ) {
            $table->id();
            $table
            ...
            $table
                ->enum("status", ["active", "converted", "expired", "released"])
                ->default("active");
        ...
        Schema::create("flash_sale_analytics", function (Blueprint $table) {
            ...
            $table->decimal("revenue", 14, 2)->default(0.0);
            $table->integer("stock_remaining")->default(0);
            $table->decimal("add_to_cart_rate", 5, 2)->default(0.0);
            $table->decimal("conversion_rate", 5, 2)->default(0.0);
            $table->decimal("cart_abandonment_rate", 5, 2)->default(0.0);
        ...
        Schema::create("flash_sale_supplier_requests", function (
            Blueprint $table,
        ) {
            $table->id();
            $table
        ...
        Schema::create("carts", function (Blueprint $table) {
            ...
            $table->string("session_id")->nullable();
            $table->string("currency", 10)->default("MGA");
            $table->decimal("subtotal", 12, 2)->default(0.0);
            $table->decimal("discount_amount", 12, 2)->default(0.0);
            $table->decimal("shipping_estimate", 12, 2)->default(0.0);
        ...
        Schema::create("orders", function (Blueprint $table) {
            ...
            $table->decimal("discount_amount", 12, 2)->default(0.0);
            $table->decimal("shipping_cost", 12, 2)->default(0.0);
            $table->decimal("tax_amount", 12, 2)->default(0.0);
            $table->decimal("platform_fee", 12, 2)->default(0.0);
        ...
        Schema::create("order_items", function (Blueprint $table) {
            ...
            // ── Commission ───────────────────────────────────────────────
            $table->decimal("commission_rate", 5, 2)->default(10.0);
            $table->decimal("commission_amount", 12, 2)->default(0.0);
            $table->decimal("supplier_revenue", 12, 2)->default(0.0);
            $table
                ->enum("status", [
                    "pending",
                    "confirmed",
        ...
        Schema::create("payment_methods_config", function (Blueprint $table) {
            ...
            $table->decimal("fee_percentage", 5, 3)->default(0.0);
            $table->decimal("fee_fixed", 10, 2)->default(0.0);
        ...
        Schema::create("transactions", function (Blueprint $table) {
            ...
            $table
                ...
                ->nullable()
                ->constrained("payment_methods_config")
                ->nullOnDelete();
            $table->enum("type", [
                "payment",
                "refund",
            ...
            $table
                ...
                ->default("pending");
            $table->decimal("amount", 12, 2);
            $table->decimal("fee_amount", 12, 2)->default(0.0);
        ...
        Schema::create("wallets", function (Blueprint $table) {
            ...
            $table->decimal("pending_balance", 14, 2)->default(0.0);
            $table->decimal("reserved_balance", 14, 2)->default(0.0);
            $table->boolean("is_active")->default(true);
            $table->timestamps();
        ...
        Schema::create("commissions", function (Blueprint $table) {
            ...
            $table
                ->enum("status", ["pending", "confirmed", "paid", "refunded"])
                ->default("pending");
            $table->timestamp("paid_at")->nullable();
            $table
                ->foreignId("payout_id")
                ->nullable()
                ->constrained("supplier_payouts")
                ->nullOnDelete();
            $table->timestamps();
        });
        ...
        Schema::create("shipments", function (Blueprint $table) {
            ...
            // ── Financier ────────────────────────────────────────────────
            $table->decimal("shipping_cost", 12, 2)->default(0.0);
            $table->decimal("transporter_earning", 12, 2)->default(0.0);
            $table->decimal("platform_shipping_fee", 12, 2)->default(0.0);
        ...
        Schema::create("returns", function (Blueprint $table) {
            ...
            $table->decimal("shipping_refund_amount", 12, 2)->default(0.0);
            $table->decimal("restocking_fee", 12, 2)->default(0.0);
            ...
            $table
                ...
                ->nullable();
            $table
                ->foreignId("exchange_product_id")
                ->nullable()
                ->constrained("products")
                ->nullOnDelete();
            $table
                ->foreignId("exchange_variant_id")
                ->nullable()
                ->constrained("product_variants")
                ->nullOnDelete();
            $table
                ->foreignId("exchange_order_id")
                ->nullable()
                ->constrained("orders")
                ->nullOnDelete();
            $table->text("supplier_notes")->nullable();
        ...
        Schema::create("return_shipments", function (Blueprint $table) {
            ...
            $table
                ->enum("cost_paid_by", ["customer", "supplier", "platform"])
                ->default("customer");
            $table->decimal("weight_kg", 8, 3)->nullable();
        ...
        Schema::create("disputes", function (Blueprint $table) {
            ...
            $table
                ...
                ->restrictOnDelete();
            $table
                ->foreignId("against_supplier_id")
                ->nullable()
                ->constrained("suppliers")
                ->nullOnDelete();
            $table
                ->foreignId("against_transporter_id")
                ->nullable()
        ...
        Schema::create("dispute_escalations", function (Blueprint $table) {
            ...
            $table->text("notes");
            $table
                ->enum("level", ["tier1", "tier2", "management"])
                ->default("tier1");
            $table
                ->enum("status", [
                    "pending",
        ...
        Schema::create("dispute_resolutions", function (Blueprint $table) {
            ...
            $table->enum("outcome", [
                ...
                "split_refund",
                "seller_penalized",
                "transporter_penalized",
                "both_parties_compensated",
                "no_action_required",
            ]);
            $table->decimal("buyer_refund_amount", 12, 2)->default(0.0);
            $table->decimal("seller_deduction_amount", 12, 2)->default(0.0);
            $table->decimal("platform_absorbed_amount", 12, 2)->default(0.0);
            $table
                ->enum("refund_method", [
                    "original_payment",
                    "wallet",
        ...
        Schema::create("product_qa", function (Blueprint $table) {
            ...
            $table
                ->enum("status", ["pending", "answered", "closed", "rejected"])
                ->default("pending");
            $table->boolean("is_featured")->default(false);
        ...
        Schema::create("product_qa_answers", function (Blueprint $table) {
            ...
            $table
                ->foreignId("product_qa_id")
                ->constrained("product_qa")
                ->cascadeOnDelete();
            $table
                ->foreignId("answered_by")
                ->constrained("users")
                ->restrictOnDelete();
        ...
        Schema::create("product_qa_votes", function (Blueprint $table) {
            $table->id();
            $table
                ->foreignId("product_qa_answer_id")
                ->constrained()
                ->cascadeOnDelete();
            $table->foreignId("user_id")->constrained()->cascadeOnDelete();
            $table->boolean("is_helpful");
        ...
        Schema::create("review_summary_stats", function (Blueprint $table) {
            ...
            $table
                ...
                ->constrained()
                ->cascadeOnDelete();
            $table->decimal("average_rating", 4, 2)->default(0.0);
            $table->unsignedInteger("total_reviews")->default(0);
            ...
            $table->decimal("avg_quality", 4, 2)->default(0.0);
            $table->decimal("avg_value_for_money", 4, 2)->default(0.0);
            $table->decimal("avg_description_match", 4, 2)->default(0.0);
            $table->decimal("avg_packaging", 4, 2)->default(0.0);
        ...
        Schema::create("customer_profiles", function (Blueprint $table) {
            ...
            $table
                ...
                ->constrained()
                ->cascadeOnDelete();
            $table->decimal("total_spent", 14, 2)->default(0.0);
            $table->unsignedInteger("total_orders")->default(0);
        ...
        Schema::create("platform_reports", function (Blueprint $table) {
            ...
            $table
                ...
                ->default("daily");
            $table->decimal("total_revenue", 14, 2)->default(0.0);
            $table->decimal("total_commission", 14, 2)->default(0.0);
            $table->decimal("total_shipping_fees", 14, 2)->default(0.0);
            $table->decimal("total_refunds", 14, 2)->default(0.0);
            $table->unsignedInteger("total_orders")->default(0);
