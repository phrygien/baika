...
<div>
    {{-- ══════════════════════════════════════════════════
         Barre filtre STICKY — une seule ligne, pas de fond coloré
         top-[57px] = hauteur exacte du flux:header
    ═══════════════════════════════════════════════════════ --}}
    <div class="sticky top-[57px] z-20 border-b border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        <div class="overflow-x-auto">
            <div class="mx-auto flex max-w-7xl items-center gap-2 px-4 py-2">

                {{-- 🔍 Search — même ligne que les filtres --}}
