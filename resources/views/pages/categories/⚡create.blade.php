...
new class extends Component
{
    ...
    public function save(): void
    {
        ...
        try {
            ...
            // Mettre à jour le path avec l'ID
            $category->update([
                ...
                <div class="rounded-xl border border-zinc-200 dark:border-zinc-700">
                    ...
                    <div class="space-y-4 p-4">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="flex size-12 shrink-0 items-center justify-center rounded-xl border-2 border-dashed border-zinc-200 bg-zinc-50 text-2xl dark:border-zinc-700 dark:bg-zinc-800">
                                @if ($icon)
                                    {{ $icon }}
                                @elseif ($image)
                ...
                <div class="rounded-xl border border-zinc-200 dark:border-zinc-700">
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        @else
                            ...
                            @else
                                <p class="text-xs text-zinc-400">
                                    {{ __('Leave empty to create a root category, or search to select a parent.') }}
                                </p>
                            @endif
                        @endif
