...
<div>
    <flux:modal name="edit-brand" class="w-full max-w-lg">
        <form wire:submit="save">
            <div class="space-y-6">

                {{-- Header --}}
                <div class="flex items-center gap-4 pr-8">
                    <div class="flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800">
                        @if ($logo)
                            <img
                                src="{{ $logo }}"
                                alt="Logo preview"
