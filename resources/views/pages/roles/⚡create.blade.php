...
{
    #[Validate('required|string|min:2|max:255|unique:roles,name')]
    public string $name = '';
...
<flux:modal name="create-role" class="w-full max-w-2xl">
    <div class="space-y-6">

        {{-- Header --}}
        <div>
            <flux:heading size="lg">{{ __('Create Role') }}</flux:heading>
            <flux:text class="mt-2">{{ __('Define a new role and assign permissions.') }}</flux:text>
        </div>
