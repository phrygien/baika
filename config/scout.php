    ...
    "typesense" => [
        ...
        "model-settings" => [
            \App\Models\Product::class => [
                ...
                "search-parameters" => [
                    "query_by" =>
                        "name,sku,short_description,brand_name,category_name,supplier_name",
                    "query_by_weights" => "10,8,3,4,3,2",
                    "sort_by" => "created_at:desc",
                    "facet_by" =>
                        "status,is_active,is_featured,is_digital,brand_id,category_id,supplier_id",
                    "per_page" => 20,
                ],
            ],
        ],
